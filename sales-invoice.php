                                    ...
                                    <form id="form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3" hidden>
                                                <label for="bankId" class="form-label" hidden>Company</label>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <?php else: ?>
                                                        <select id="company_id" name="company_id" class="form-select" hidden>
                                            ...
                                            <div class="col-md-2" hidden>
                                                <label for="customerVatNumber" class="form-label" hidden>Customer Vat Number</label>
